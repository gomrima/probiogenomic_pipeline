...
STEP_ID="09_run_mobile_safety_cooccurrence"
SCRIPT="$SCRIPT_DIR/09_mobile_safety_cooccurrence.py"
LOG_DIR="$PIPE_ROOT/results/logs"
CHECKPOINT_DIR="$PIPE_ROOT/work/checkpoints"
TMPDIR_PATH="${TMPDIR:-$PIPE_ROOT/work/tmp}"
LOG_FILE="$LOG_DIR/09_run_mobile_safety_cooccurrence.log"
CHECKPOINT_FILE="$CHECKPOINT_DIR/09_run_mobile_safety_cooccurrence.done"
